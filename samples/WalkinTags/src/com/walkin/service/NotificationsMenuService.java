...
public class NotificationsMenuService {
    private static NotificationsMenuService instance = null;
...
//    public static final String NOTIFICATIONS_TYPE = "type";
    ...
    public static final String JSONObj_item_unread = "JSONObj_item_unread";
...
//	private String type; 
    ...
    private NotificationsMenuService(){}

    public static NotificationsMenuService getInstance(){
        if(instance == null){
            instance =  new  NotificationsMenuService();
        }
        return instance;
    }
    ...
    public void retrieveNotificationsInfo(){
        try{
...
//                Log.d("Rock", jsStr+"=111111111111111");
            ...
            JSONArray JOARRAY_notifications = null;
...
//            type= JSONOBJ_notifications.getString(NOTIFICATIONS_TYPE);
            ...
            JOARRAY_notifications=	JSONOBJ_response.getJSONArray("notifications");
list_jobj_item = new ArrayList<Map<String, Object>>(); 
            for (int i = 0; i < JOARRAY_notifications.length(); i++) {     
map_item = new HashMap<String, Object>(); // 存放到MAP里面     
JSONObj_item = JOARRAY_notifications.getJSONObject(i); // 得到每个对象     

			   String JSONObj_item_id = JSONObj_item.getString("id");  
	           String JSONObj_item_imagesURL = JSONObj_item.getString("imageUrl"); 
			   String JSONObj_item_text = JSONObj_item.getString("text");
	           String JSONObj_item_type = JSONObj_item.getString("type");
	           String JSONObj_item_unread = JSONObj_item.getString("unread");     
           
      	    	map_item.put("JSONObj_item_id",JSONObj_item_id);    
      	    	map_item.put("JSONObj_item_imagesURL",JSONObj_item_imagesURL); 
      	    	map_item.put("JSONObj_item_text",JSONObj_item_text);   
	      	  	map_item.put("JSONObj_item_type",JSONObj_item_type);    
	      	  	map_item.put("JSONObj_item_unread",JSONObj_item_unread);    
    ...
    public void retrieveNotificationsInfoParams(Map<String, String> params1){
        try{
...
//            type= JSONOBJ_notifications.getString(NOTIFICATIONS_TYPE);
          ...
          /*  JSONOBJ_response = json.getJSONObject("response");
            ...
            JOARRAY_notifications=	JSONOBJ_response.getJSONArray("notifications");
list_jobj_item = new ArrayList<Map<String, Object>>(); 
if(JOARRAY_notifications!=null && !"".equals(JOARRAY_notifications)){
            for (int i = 0; i < JOARRAY_notifications.length(); i++) {     
map_item = new HashMap<String, Object>(); // 存放到MAP里面     
JSONObj_item = JOARRAY_notifications.getJSONObject(i); // 得到每个对象     
